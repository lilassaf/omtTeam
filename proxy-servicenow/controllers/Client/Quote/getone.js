...
module.exports = async (req, res) => {
  try {
    const quoteNumber = req.params.number; // Assuming the number comes from URL params like /quotes/number/:number

    // Build aggregation pipeline for a single quote by number
    const pipeline = [
      { $match: { number: quoteNumber } }, // Match by number instead of _id

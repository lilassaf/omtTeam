...
const SERVICE_NOW_CONFIG = {
  ...
  username: process.env.SERVICE_NOW_USER || 'mouad.abarhane',
  password: process.env.SERVICE_NOW_PASSWORD || 'K5F/Uj/&=TrK#)1#Isguye4HQ!*qp*m&0@cSPoC5iF3=7R*G]OIm,B$<C*0.eG9RgoT&b.',
  tables: {
